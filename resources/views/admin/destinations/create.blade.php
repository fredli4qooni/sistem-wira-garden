        ...
        <div class="p-6 sm:p-8">
            <form action="{{ route('admin.destinations.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="open_hours" id="open_hours" required class="block w-full border-gray-200 rounded-xl shadow-sm focus:ring-secondary focus:border-secondary transition-colors py-3 px-4 bg-gray-50 focus:bg-white" value="{{ old('open_hours') }}" placeholder="Contoh: 08:00 - 17:00">
